...
export function buildTelegramPreviewVars(defaultLocaleCode: string): TelegramTemplateVars {
  return {
    ...
    customer_email: 'ayse@katalogai.com',
    customer_phone: '+90 532 000 0000',
    company_name: 'KatalogAI',
    message: 'Yeni bir katalog olusturmak istiyorum.',
    created_at: '2026-03-20 10:30:00',
    product_service: 'Katalog tasarim hizmeti',
    subject: 'Katalog olusturma talebi',
    name: 'Mehmet Demir',
